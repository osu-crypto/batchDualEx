	...
	void BtAcceptor::start() 
	{
		if (stopped() == false)
		{
			...
			mHandle.async_accept(newSocket->mHandle, [newSocket, this](const boost::system::error_code& ec)
			{
						...
						[newSocket, buff, this](const boost::system::error_code& ec2, u64 bytesTransferred)
					{
						if(!ec2 || bytesTransferred != 4)
						{
								...
								[newSocket, buff, size, this](const boost::system::error_code& ec3, u64 bytesTransferred2)
							{
								...
								{
									Lg::out << "async_accept->async_receive->async_receive (body) failed with error_code:" << ec3.message() << Lg::endl;
								}
						...
						{
							Lg::out << "async_accept->async_receive (header) failed with error_code:" << ec2.message() << Lg::endl;
							delete newSocket;
							delete buff;
						}
				...
				{
					//Lg::out << "async_accept failed with error_code:" << ec.message() << Lg::endl;
					delete newSocket;
				}
			});
		}
