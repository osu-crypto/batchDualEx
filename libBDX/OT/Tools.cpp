...
//		G.SetSeed(prngSeed);
//
//		ByteStream mySeed(len), myComm, myOpen;
//		ByteStream theirSeed, theirComm, theirOpen;
//
//		G.get(mySeed.data(), len);
//
//		Commit Comm(myComm, myOpen, mySeed, G);
//
//		channel.send(myComm);
//		channel.recv(theirComm);
//
//		channel.send(myOpen);
//		channel.recv(theirOpen);
//
//		memset(seed, 0, len*sizeof(u8));
//
//		if (!CommitOpen(theirSeed, theirComm, theirOpen))
//		{
//			Lg::out << Lg::all << "commitment Open failed" << Lg::endl;
//			throw invalid_commitment();
//		}
//
//		//Lg::out << "Their str  " <<  theirSeed  << Lg::endl;
//		for (int i = 0; i < len; i++)
//		{
